...
Interactive selector for shell pipelines.
...
Build and restart Spring Boot applications during development.
...
List or clean merged branches.

```sh
git merged [branch]
git merged --clean [branch]
```
